...
{
    public class InventoryCommandHandlers : Handles<CreateInventoryItem>, Handles<DeactivateInventoryItem>, Handles<RemoveItemsFromInventory>, Handles<CheckInItemsToInventory>, Handles<RenameInventoryItem>
    {
