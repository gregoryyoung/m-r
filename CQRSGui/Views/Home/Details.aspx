...
<asp:Content runat="server" ID="Main" ContentPlaceHolderID="MainContent">
    ...
    Id: <%:Model.Id%><br />
    Name: <%:Model.Name%><br />
    Count: <%: Model.CurrentCount %><br />
    <br />
    <%: Html.ActionLink("Rename", "ChangeName", new {Id = Model.Id}) %><br />
    <%
        using (Html.BeginForm("Deactivate", "Home", FormMethod.Post, new { id = "DeactivateForm" }))
        {
    %>
    <%: Html.HiddenFor(m => m.Id)  %>
    <%: Html.HiddenFor(m => m.Version)  %>
    <a href="#" onclick="document.getElementById('DeactivateForm').submit();">Deactivate</a>
    <% } %>
